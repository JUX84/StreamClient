 ...
 */
public class SpeeralAudioRecorder {
	...
	public SpeeralAudioRecorder(Ice.Communicator communicator, Activity activity) {
	...
	private void initServer() {
		try {
			Ice.ObjectPrx base = communicator.stringToProxy("SpeeralServer:tcp -h server.datdroplet.ovh -p 10000");
			server = speeral.ServerPrxHelper.checkedCast(base);
		} catch (Exception e) {
			Log.e("SpeeralServer", e.toString());
		}
	}
